...
import alert.AlertFormatter;
import alert.MergedAlertGraph;
...
//                System.out.println(eventCount);
                ...
                if (tag == null) return;
                    ...
                    if (outputTarget.equals("kafka"))
                        ...
                        String alertLog = "src/RunningLog/alert.log";
                        try(FileWriter writer = new FileWriter(alertLog, true)) {
                            writer.append(alertJsonString);
