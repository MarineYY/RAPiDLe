...
public class EventFrequencyDBConstructionWithFlink extends KeyedProcessFunction<PDM.HostUUID, PDM.Log, Row> {
    public static Long dbDumpEventCount = 600000L;
//    public static Long dbDumpEventCount = 5L;
...
//        Tuple2<String, String> dbStrings = dumpEventFrequencyDBToStrings();
        ...
        System.out.println("sourceRelationshipMatchEventFrequencyMap : " + output.f1.size());
        ObjectOutputStream objectOutputStream = new ObjectOutputStream(new FileOutputStream("src/main/Database/EventFrequencyDB-ubantu.out"));
