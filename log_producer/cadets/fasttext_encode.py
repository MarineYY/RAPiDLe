...
from cadets.config import event_csv_list, event_npy_list, event_csv_predict_list, log_list
...
if __name__ == '__main__':
    word_vectors_path = '/home/yangyangwei/Baseline_Frequency/cadets/data/word_vectors.kv'
